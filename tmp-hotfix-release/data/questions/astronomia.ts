...
👉 Alternativa correta: C.`,
  ...
  explanation:
    'A culminação ocorre quando o Sol cruza o meridiano local. A partir do ANB utilizado na prova CPA-I/2025, obtém-se o instante da passagem meridiana em Greenwich e aplica-se a correção de longitude, convertida em tempo, para a posição estimada. Em seguida, faz-se o ajuste para a Hora Legal do fuso adotado no enunciado. O resultado conduz à alternativa E.',
...

{
  ...
  statement:
    'Na data de 03 de junho de 2025, para a posição estimada da embarcação, sabendo que a observação da culminação ocorreu à HMG = 16h 16m, determine no Almanaque Náutico a declinação do Sol nesse instante.',
  ...
  explanation:
    'Deve-se consultar o ANB para 03 de junho de 2025 usando a HMG da observação da culminação na posição estimada da embarcação, e não apenas o horário de culminação em Z. Com HMG = 16h 16m, a interpolação fornece declinação aproximada de 22° 21,2’ Norte.',
...

{
  ...
  explanation:
    'Parte-se da altura instrumental observada em 03 de junho de 2025. Aplica-se a correção do erro instrumental (+1,3’), depois a correção de dip, negativa em razão da altura do olho, e por fim a correção tabulada do Sol no ANB para o período de abril a setembro, que incorpora os ajustes usuais de refração, semidiâmetro e paralaxe. O resultado final conduz à altura verdadeira aproximada de 78° 30,0’.',

  attachments: [
    { label: 'ANB 2025 - Correção de altura do Sol (abril a setembro)', path: '/anexos/anb-2025-altura.pdf' },
  ],
},

{
  ...
  statement:
    'Sabendo que, em 03 de junho de 2025, a altura verdadeira do Sol na culminação foi de aproximadamente 78° 30,0’ e que a declinação solar nesse instante era cerca de 22° 21’ N, determine a latitude meridiana do navegante.',
