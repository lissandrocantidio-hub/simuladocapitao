...
export const meteorologiaQuestions: Question[] = [
  ...
  },
  {
    ...
    verified: true,
    statement:
      'O nevoeiro produzido pelo resfriamento noturno do solo, com ar umido junto a superficie terrestre, recebe o nome de:',
    options: {
      A: 'Frontal.',
      B: 'Advecção.',
      C: 'Orográfico.',
  ...
  },
  {
    ...
    verified: true,
    statement:
      'Em um sistema frontal com depressao proxima a frente fria, a diferenca de pressao entre os anticiclones das massas de ar indica principalmente a',
    options: {
  ...
  },
  {
    ...
    correct: 'B',
    explanation:
      'No nevoeiro de adveccao, o ar quente e umido passa sobre uma superficie do mar mais fria, resfria-se por baixo e condensa. Aqui, TPO significa temperatura do ponto de orvalho e TSM significa temperatura da superficie do mar. Quando a TPO fica acima da TSM, o ar tende a atingir a saturacao ao encontrar a agua mais fria. Ventos fracos a moderados ajudam a transportar esse ar e favorecem a formacao do nevoeiro. Ja UR significa umidade relativa, e T representa a temperatura do ar.',
  },
  {
    id: 2017036,
    subject: 'meteorologia',
