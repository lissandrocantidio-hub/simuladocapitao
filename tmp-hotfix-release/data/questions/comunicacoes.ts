...
export const comunicacoesQuestions: Question[] = [
  ...
  },
  {
    ...
    correct: 'D',
    explanation:
      'GMDSS significa Sistema Global de Socorro e Seguranca Maritima. MSI significa informacoes de seguranca maritima. O SAFETYNET e um servico via satelite usado para distribuir essas informacoes, inclusive na Area A3 do GMDSS. As demais alternativas confundem a definicao das areas de mar ou das responsabilidades. Por isso, a alternativa correta e a D.',
  },
  {
    id: 20252024,
    subject: 'comunicacoes',
  ...
  },
  {
    ...
    verified: true,
    statement:
      'Durante a participacao na REFENO, um capitao-amador ouviu no VHF de bordo, no canal de escuta permanente, uma mensagem de MAYDAY informando naufragio nas proximidades de Fernando de Noronha. Em seguida, identificou na area indicada um facho de luz vermelha de forte intensidade, sendo sua embarcacao a unica proxima da posicao informada. Quanto ao dever de prestar assistencia a quem estiver em perigo no mar, assinale a alternativa correta.',
    options: {
      A: 'Por estar em competicao, o capitao nao tera o dever de atender ao chamado.',
      B: 'Qualquer embarcacao que preste auxilio podera cobrar, desde logo, os eventuais custos do socorro.',
      ...
      E: 'O capitao podera prosseguir em sua derrota, pois a mensagem recebida caracteriza apenas situacao de urgencia.',
    },
    correct: 'C',
    explanation:
  ...
  },
  {
    ...
    correct: 'A',
    explanation:
      'VHF e a faixa de radio de muito alta frequencia usada amplamente na navegacao costeira. DSC significa Digital Selective Call, ou chamada seletiva digital. No VHF maritimo, o DSC usa o canal 70, nao o 71. Por isso, a alternativa A e a incorreta e, portanto, a resposta certa da questao.',
  },
  {
    id: 20242019,
    subject: 'comunicacoes',
    ...
    correct: 'D',
    explanation:
      'SES significa Ship Earth Station, isto e, a estacao terrena de bordo. O INMARSAT-C e um terminal satelital de mensagens do sistema Inmarsat. Nesse caso, a operacao continua possivel mesmo com bastante adernamento porque a antena e praticamente onidirecional e nao exige apontamento fino. Por isso, a alternativa correta e a D.',
  },
  {
    id: 20242020,
    subject: 'comunicacoes',
    ...
    correct: 'B',
    explanation:
      'EPIRB significa Emergency Position Indicating Radio Beacon, uma baliza de emergencia que transmite alerta de socorro. Nas EPIRBs de 406 MHz, a autonomia minima deve garantir transmissao continua por pelo menos 48 horas. Por isso, a alternativa correta e a B.',
  },
  {
    id: 20242021,
    subject: 'comunicacoes',
  ...
  },
  {
    id: 20232026,
    subject: 'comunicacoes',
    topic: 'GMDSS / correlaÃ§Ã£o de Ã¡reas e serviÃ§os',
    year: 2023,
    exam: 'CPA-II 2023',
    source: 'Prova oficial da Marinha',
    verified: true,
    statement:
      'De acordo com o Sistema Global MarÃ­timo de Socorro e SeguranÃ§a (GMDSS), correlacione a coluna da esquerda com a da direita e marque a alternativa correta.\n\n(1) Ãrea A1\n(2) SISTRAM\n(3) NAVAREA V\n(4) RENEC\n(5) SAFETYNET\n(6) METAREA IV\n(7) Ãrea A2\n(8) CISMAR\n(9) NAVTEX\n(10) Rede costeira de apoio ao iatismo\n\nItens a correlacionar:\n- Atende Ã  Ãrea A3 e utiliza o sistema INMARSAT de comunicaÃ§Ãµes.\n- Ã“rgÃ£o da MB responsÃ¡vel pelo acompanhamento do trÃ¡fego marÃ­timo na Ã¡rea SAR brasileira.\n- Ãrea marÃ­tima brasileira de responsabilidade da DHN de disseminaÃ§Ã£o das MSI.\n- Situada dentro da cobertura radiotelefÃ´nica com uma estaÃ§Ã£o costeira em MF, em que um permanente alerta DSC em MF esteja disponÃ­vel.\n- Presta serviÃ§o de radiocomunicaÃ§Ãµes terra-embarcaÃ§Ã£o-terra, em apoio Ã  seguranÃ§a da navegaÃ§Ã£o e Ã  salvaguarda da vida humana no mar.',
    options: {
      A: '9 - 4 - 6 - 1 - 4',
      B: '2 - 2 - 3 - 6 - 2',
      C: '1 - 8 - 1 - 3 - 10',
    ...
    correct: 'D',
    explanation:
      'SAFETYNET Ã© o serviÃ§o de MSI via INMARSAT para a Ãrea A3; CISMAR Ã© o Ã³rgÃ£o da MB ligado ao acompanhamento do trÃ¡fego na Ã¡rea SAR brasileira; NAVAREA V Ã© a Ã¡rea brasileira de avisos aos navegantes; a Ãrea A2 Ã© a de cobertura MF com DSC; e a RENEC presta apoio de radiocomunicaÃ§Ãµes terra-embarcaÃ§Ã£o-terra ao iatismo. Essa sequÃªncia corresponde Ã  alternativa D.',
  },
  {
    id: 20232027,
    subject: 'comunicacoes',
    ...
    verified: true,
    statement:
      'De acordo com os procedimentos radiotelefonicos, uma estacao que tem uma mensagem urgente concernente a seguranca de uma embarcacao, aeronave ou pessoa deve iniciar a transmissao por:',
    options: {
