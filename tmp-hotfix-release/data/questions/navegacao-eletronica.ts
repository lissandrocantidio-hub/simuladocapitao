...
export const navegacaoEletronicaQuestions: Question[] = [
  {
    ...
    correct: 'E',
    explanation:
      'ECDIS significa Electronic Chart Display and Information System, ou sistema eletronico de exibicao e informacao em cartas nauticas. GNSS significa Global Navigation Satellite System, conjunto de sistemas de posicionamento por satelite. E esse posicionamento em tempo real do GNSS que permite ao ECDIS mostrar o navio corretamente sobre a carta eletronica.',
  },
  {
    id: 2022008,
    subject: 'navegacao-eletronica',
...
ðŸ‘‰ Alternativa correta: E.`,
  ...
  },
  {
    ...
    correct: 'B',
    explanation:
      'ARPA significa Automatic Radar Plotting Aid, recurso do radar para acompanhamento automatico de alvos. Ele fornece, entre outros dados, rumo, distancia, CPA e TCPA. CPA e a distancia minima prevista de aproximacao entre embarcacoes, e TCPA e o tempo ate essa aproximacao. A velocidade relativa do alvo, do jeito pedido no enunciado, nao aparece como informacao primaria. Por isso, a alternativa B e a correta.',
  },
  {
    id: 2022012,
    subject: 'navegacao-eletronica',
  ...
  },
  {
    ...
    correct: 'B',
    explanation:
      'ARPA significa Automatic Radar Plotting Aid, recurso do radar para rastrear alvos. AIS significa Automatic Identification System, sistema de identificacao automatica entre embarcacoes. GNSS significa Global Navigation Satellite System, base dos dados de posicao por satelite. A alternativa incorreta e a B porque nao se pode afirmar de forma geral que o ARPA tenha alcance maior que o AIS. O desempenho de cada sistema depende de propagacao, altura de antena, linha de visada e caracteristicas proprias do sensor.',
  },
  {
    id: 2022014,
    subject: 'navegacao-eletronica',
    ...
    correct: 'D',
    explanation:
      'TTG significa Time To Go, isto e, tempo restante para atingir o ponto considerado. Em equipamentos GNSS, essa informacao indica em quanto tempo a embarcacao chegara ao ponto de guinada ou waypoint, mantendo a velocidade atual.',
  },
  {
    id: 2022015,
    subject: 'navegacao-eletronica',
  ...
  },
  {
    ...
    correct: 'D',
    explanation:
      'VTS significa Vessel Traffic Service, ou servico de trafego de embarcacoes. Dentro dele, INS significa Information Service, servico que fornece informacoes uteis ao navegante, e TOS significa Traffic Organization Service, servico voltado a organizar os movimentos do trafego. A afirmativa I esta incorreta porque uma estacao de praticagem pode ter equipamentos parecidos com os de um VTS, mas isso nao a transforma automaticamente em VTS com autoridade para interferir no trafego. Ja as afirmativas II, III e IV descrevem corretamente o sistema. Por isso, a alternativa correta e a D.',
  },
  {
    id: 2023009,
    subject: 'navegacao-eletronica',
  ...
  },
  {
    ...
    correct: 'D',
    explanation:
      'CPA significa distancia minima prevista de aproximacao, e TCPA significa tempo ate essa aproximacao. Ao ajustar o TCPA LIMIT, o operador define com quanta antecedencia quer ser alertado para avaliar o risco e agir a luz do RIPEAM. Por isso, a alternativa correta e a D.',
  },
  {
    id: 2023012,
    subject: 'navegacao-eletronica',
...
Assinale a opção correta.`,
    ...
    correct: 'C',
    explanation:
      'VTS significa Vessel Traffic Service, ou servico de trafego de embarcacoes. NAS significa Navigational Assistance Service, isto e, servico de assistencia a navegacao, usado quando o navegante precisa de apoio mais direto. A afirmativa II e falsa porque a responsabilidade do comandante pela seguranca da embarcacao continua existindo. Ja as afirmativas I, III e IV estao de acordo com a estrutura e com os servicos do VTS. Por isso, a alternativa correta e a C.',
  },
  {
    id: 20212022,
    subject: 'navegacao-eletronica',
