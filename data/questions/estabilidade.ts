...
export const estabilidadeQuestions: Question[] = [
  {
    ...
    correct: 'E',
    explanation:
      'GM significa altura metacentrica transversal, uma medida importante da estabilidade inicial da embarcação. Quando o GM e negativo, a embarcação perde a tendencia natural de voltar a posição de equilibrio depois de adernar e pode emborcar. Por isso, a alternativa correta e a E.',
  },
  {
    id: 2022039,
    subject: 'estabilidade',
  ...
  },
  {
    ...
    verified: true,
    statement:
      'Marque a alternativa correta sobre a CEE (Curva de Estabilidade Estatica). Se a curva apresenta GZ inicial negativo para pequenos ângulos, isso indica:',
    options: {
      A: 'embarcação com GM negativo (equilibrio inicial instavel).',
      B: 'embarcação com GM positivo (equilibrio inicial estavel).',
      C: 'embarcação com GM exatamente igual a zero em qualquer condição.',
      D: 'apenas erro de leitura, sem relacao com estabilidade inicial.',
      E: 'efeito exclusivo de trim longitudinal, sem relacao com GM.',
    },
    correct: 'A',
    explanation:
      'Quando a CEE comeca com GZ negativo para pequenos ângulos, a embarcação nao tem tendencia inicial de retorno e o equilibrio inicial e instavel. Isso caracteriza GM negativo. Por isso, a alternativa correta e a A.',
  },
  {
    id: 20222034,
    subject: 'estabilidade',
    ...
    attachments: [
      {
        ...
        path: '/anexos/cpa2-2022-hidrostatica.png',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: {
      A: 'transferir peso para boreste é mais para cima.',
  ...
  },
{
  ...
  verified: true,
  statement:
    'Assinale a alternativa que nao esta de acordo com os fundamentos teoricos da estabilidade de embarcações.',
  options: {
    A: 'No centro de carena atua a resultante das forcas de empuxo e sua posição muda com o calado.',
    B: 'Quando uma embarcação aderna, o centro de carena descreve uma curva cujo centro e o metacentro transversal.',
    C: 'A altura metacentrica e a distância vertical entre o centro de gravidade e o centro de carena.',
    D: 'A resultante de todos os pesos atua no centro de gravidade.',
    E: 'O centro de carena muda quando ocorre inclinacao na embarcação.',
  },
  correct: 'C',
  explanation:
...
},
{
  ...
  verified: true,
  statement:
    'Considerando conceitos e definições usados em estabilidade de embarcações, assinale a alternativa incorreta.',
  options: {
    A: 'Durante a viagem, o consumo de água, provisões e combustível altera a altura metacêntrica.',
    B: 'Se o calado a vante é maior que o calado a ré, o compasso é positivo e a embarcação está embicada.',
    C: 'Ao içar uma carga por pau de carga, o KG aumenta, e um deslocamento horizontal do ponto de içamento move o centro de gravidade horizontalmente.',
    D: 'Reserva de flutuação é a soma dos espaços fechados e estanques acima da linha d’água.',
    E: 'O valor de KM pode ser obtido por curvas hidrostáticas em função do calado médio.',
  },
  correct: 'B',
  explanation:
...
},
{
  ...
  verified: true,
  statement:
    'Quando um tanque e dividido por anteparas longitudinais, qual o efeito sobre a estabilidade da embarcação',
  options: {
    A: 'Eleva o centro de gravidade.',
    B: 'Mantem o centro de gravidade.',
    C: 'Aumenta o efeito da superfície livre.',
    D: 'Mantem o efeito da superfície livre.',
    E: 'Diminui o efeito da superfície livre.',
  },
  correct: 'E',
  explanation:
    'A subdivisao longitudinal reduz a largura livre do l?quido e, com isso, diminui o efeito de superfície livre sobre a estabilidade transversal. Por isso, a alternativa correta e a E.',
},
]
